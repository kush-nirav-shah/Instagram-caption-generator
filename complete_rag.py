...
# docA = Document(page_content="My name is kush")
def create_db(url):
...
def create_chain(vectoreStore: FAISS):
    config={'context_length':1024,
            'temperature':0}
    model="D:\SGP 6\mistral-7b-instruct-v0.1.Q5_K_M.gguf"
    ...
    prompt = ChatPromptTemplate.from_messages([
        ("system","You are a expert in writing instagram captions. write a caption for instagram with emoji and hashtag{context}."),
...
if __name__ == "__main__":
    url = "https://www.oberlo.com/blog/instagram-captions"
    ...
    while True:
        user_input = input("Write Text Prompt: ")
